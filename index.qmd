...
#| tbl-colwidths: [1.0, 1.0, 0.7, 0.7, 1.0, 1.0, 0.5, 0.8, 1.0, 0.5]

tar_read(test_results)$adjusted$mPA |>
  mutate( Variable = if_else(Variable == "cPA", "Physical Activity", Variable) ) |>
  
  gt(groupname_col = c("Variable","y") ) |>
...
tar_read(test_results)$unadjusted$mPA |>
  mutate( Variable = if_else(Variable == "cPA", "Physical Activity", Variable) ) |>
